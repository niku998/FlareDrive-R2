  ...
  >
    ...
    <div class="app-bar">
      <a class="app-title-container" style="display: flex; align-items: center;" href="/">
        <img src="/assets/homescreen.png" alt="CxDrive" style="height: 24px" />
        <h1 class="app-title" style="font-size: 20px;margin: 0 25px 0 8px; user-select: none;">CxDrive</h1>
      </a>
    ...
    cwd: {
      handler() {
        ...
        document.title = this.cwd.replace(/.*\/(?!$)|\//g, "") === "/" 
            ? "主页 - CxDrive网盘文库"
            :`${this.cwd.replace(/.*\/(?!$)|\//g, "") || "/" } - CxDrive网盘文库`;
      },
      immediate: true,
    },
  },
